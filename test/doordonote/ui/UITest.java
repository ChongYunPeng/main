...
public class UITest {
	...
	String dateInString4 = "19/06 24:61";
	...
	public void testGetDay() {
		try {
			...
			Calendar cl1 = util.DateToCalendar(dt1);
			Calendar cl2 = util.DateToCalendar(dt2);

			String day1 = util.getDay(cl1);
			String day2 = util.getDay(cl2);
	...
	public void testGetMonth() {
		try {
			...
			String month1 = util.getMonth(cl1);
			String month3 = util.getMonth(cl3);
	...
	public void testGetTime() {
		try {
			...
			Calendar cl1 = util.DateToCalendar(dt1);
			Calendar cl3 = util.DateToCalendar(dt3);
			Calendar cl4 = util.DateToCalendar(dt4);

			String time1 = util.getTime(cl1);
			String time3 = util.getTime(cl3);
			String time4 = util.getTime(cl4);
